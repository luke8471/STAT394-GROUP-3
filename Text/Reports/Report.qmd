...
In 2015, of the coast of Gela Italy, a veritable hoard of 40 Orichalcum ingots were dredged up. There has never been a find of this magnitude....

Determining the elemental composition of each ingot gives vital information for geomapping the origin of each piece. This information maps the history of this ancient alloy (give locations), and informs further methodologies for discovering ore sources, processing refineries, more orichalcum, and an insight into manufacturing processes....

The importance of elemental composition something about a history of various alloys being empirically called "orichalcum" without the data to back it up.

Multivariate analysis of the chemometric analysis gives x distinct groupings of ingots
...
Because it could lead to further impressive archaeological finds and helps locate ancient refineries.

What is the scope of the work and what problem is this paper trying to solve?

Determine whether or not any of the ingots could be grouped. The scope is mapping orichalcum ingot origin.

What was done to solve this problem?

More destructive testing to determine trace elements. Initial testing was non-invasive until
...
Overall similarities suggest a rudimentary mold production, likely a hole dug in the ground and molten alloy was poured in the indentation to solidify. The morphology of the found ingots suggestd cast-diverse technologies. Impurities are atttributed to a separation process that occured during the fusion (Caponetti et. al. 2017) of metals to create the alloy.
